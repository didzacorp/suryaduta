        ...
        <div class='col-md-12'>
            <div class='card header_card'>
                <div class='card-body'>
                    ...
                    <h3 class='heading text-center'>Rp ".number_format($data['transaksi']['sub_total'])."</h3>
        ...
        <div class='col-md-12'>
            <div class='card card_rounded'>
                <div class='card-body text-center'>
                    ...
                    <h3 >Rp.".number_format($data['transaksi']['sub_total']+$data['transaksi']['kode_unik'])."</h3>
                    ...
                    <p class='card-text'>note : kami menambahkan nominal sebesar <strong >".$data['transaksi']['kode_unik']."</strong> untuk memudahkan proses konfirmasi transaksi.</p>
