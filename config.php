...
|
*/
$config['encryption_key'] = 'kingOfAPESDMS@2018';
...
$config['sess_cookie_name'] = 'SuryaDuta_session';
...
$config['csrf_token_name'] = 'csrf_dealerdms_name';
$config['csrf_cookie_name'] = 'csrf_dealerdms2018_name';
